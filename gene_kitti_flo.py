...
# example path : "./images/000000.png"
	path_str1 = "./images/"
	path_str3 = ".png"
	datasets_number = 10
	for i in range(datasets_number):
		path_first = path_str1 + return_str6(i) + path_str3
		path_second = path_str1 + return_str6(i+1) + path_str3

		arguments_strFirst = path_first
		arguments_strSecond = path_second
		arguments_strOut = path_str1 + return_str6(i) + ".flo"
